...
//Hello my fellow programmers! What you are looking at is the source code for a program that I haven't updated
//in over 4 years. I hope you enjoy this official source code ( ^ _ ^ )

LRESULT CALLBACK WndProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam);
LRESULT CALLBACK MDIChildWndProc(HWND hwnd, UINT Message, WPARAM wParam,LPARAM lParam);

char g_szAppName[] = "Analysis72";
char g_szChild[] = "Analysis72Client";
HINSTANCE g_hInst;
...
BOOL GetFileName(HWND hwnd, LPSTR pszFileName, BOOL bSave) {
	...
	ofn.hwndOwner = hwnd;
	ofn.lpstrFilter = "Analysis-72 Documents (*.a72)\0*.a72\0Text Documents (*.txt)\0*.txt\0Other Files (*.*)\0*.*\0\0";
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance,LPSTR lpszCmdParam, int nCmdShow) {
	...
	g_hMainWindow = CreateWindowEx(WS_EX_APPWINDOW,g_szAppName,"Analysis-72 4.0",WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN,
		CW_USEDEFAULT,
		CW_USEDEFAULT,
		CW_USEDEFAULT,
		CW_USEDEFAULT,
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam) {
	switch(Message) {
		case WM_CREATE: {
			...
			SendMessage(g_hStatusBar, SB_SETTEXT, 2, (LPARAM)"2018-2023");
